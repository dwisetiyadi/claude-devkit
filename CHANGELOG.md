...
### Changed
- Sharpened the subagent-offload guidance: a subagent saves the main-thread context, not total tokens (those usually rise); parallel saves wall-clock time, not tokens; offload only BIG context in a long session.
